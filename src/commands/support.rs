...
pub fn run() {
    ...
    println!();
    println!("Vauchi is community-funded. No venture capital, no data harvesting.");
    println!("Your support keeps development going.");
    println!();
    println!("  GitHub Sponsors: https://github.com/sponsors/vauchi");
    println!("  Liberapay:       https://liberapay.com/Vauchi/donate");
    println!();
